...
<div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document" style="    height: 170%;">
    <div class="modal-content"  style="    height: 40%;" >
      ...
      <div class="modal-body">
        ...
        @csrf
        <label for="message" class="form-label" style="margin-top: 25px;">News Text</label>
               
        <input type="text" class="form-control" name="news" style="height: 100px; border-radius: 10px; width: 448px;" id="newstext" placeholder="News Text"  required>
        
        <div class=" mt-5">

        <label for="tiletext" class="form-label">News Title</label>
        <input name="title" class="form-control" type="text" placeholder="News Title" id="newstitle" style="width: 448px;">
        ...
        <label for="formFile" class="form-label">Upload Picture</label>
          <input name="pic" class="form-control" type="file" id="formFile" style="width: 448px;">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" style="background-color: black ; border-color: black " >Upload News</button>
